...
async def start(bot, update):
    update_channel = "@the_mallu_casino"
    if update_channel:
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 🔰JOIN OUR CHANNEL🔰 ", url=f"https://t.me/the_mallu_casino")]
              ])
            )
            return
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '⚠️ 𝗝𝗢𝗜𝗡 𝗢𝗨𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⚠️', url="https://t.me/the_mallu_casino"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('⚠️ JOIN', url='https://t.me/the_mallu_casino'),
    ...
    await bot.send_photo(
        chat_id=update.chat.id,
        photo="https://telegra.ph/file/0c28e14fbd5f5c21fe2fa.jpg",
