...
async def auto_filter(bot, update):
    ...
    if filters:
        results.append(
                [
                    InlineKeyboardButton("⚠️ ERROR CLICK HERE ⚠️", url="https://t.me/joinchat/fRLWk4-dsRA1MTA1")
                ]
            )
        ...
        Send_message = await bot.send_message(
            ...
            text="<b>Couldn't Find This Movie.Try Again ഈ സിനിമയുടെ ഒറിജിനൽ പേര് ഗൂഗിളിൽ പോയി കണ്ടെത്തി അതുപോലെ ഇവിടെ കൊടുക്കുക www.google.com 🥺</b>",
